package com.javaweb.orders.service.impl;
...
import com.javaweb.base.utils.IdWorkerUtils;
import com.javaweb.base.utils.QRCodeUtil;
import com.javaweb.messagesdk.model.po.MqMessage;
import com.javaweb.messagesdk.service.MqMessageService;
import com.javaweb.orders.config.AlipayConfig;
import com.javaweb.orders.config.PayNotifyConfig;
import com.javaweb.orders.mapper.XcOrdersGoodsMapper;
import com.javaweb.orders.mapper.XcOrdersMapper;
import com.javaweb.orders.mapper.XcPayRecordMapper;
...
import com.javaweb.orders.model.po.XcOrders;
import com.javaweb.orders.model.po.XcOrdersGoods;
import com.javaweb.orders.model.po.XcPayRecord;
import com.javaweb.orders.service.OrderService;
...
//创建商品订单
    ...
    public PayRecordDto queryPayResult(String payNo){
        ...
        if (payRecord == null) {
            JavaWebException.cast("请重新点击支付获取二维码");
        }
        //支付状态
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo){
        ...
        try {
            ...
            if (!response.isSuccess()) {
                JavaWebException.cast("请求支付查询查询失败");
            }
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto){
        ...
        XcPayRecord payRecord = getPayRecordByPayno(payNo);
        if (payRecord == null) {
            JavaWebException.cast("支付记录找不到");
        }
        //关联的订单号
        Long orderId = payRecord.getOrderId();
        XcOrders orders = ordersMapper.selectById(orderId);
        if (orders == null) {
            JavaWebException.cast("根据支付记录找不到订单");
        }
        //支付结果
        ...
        if (trade_status.equals("TRADE_SUCCESS")) {
            ...
            if (totalPrice.intValue() != total_amount.intValue()) {
                ...
                JavaWebException.cast("校验支付结果失败");
            }
            ...
            if (update1 > 0) {
                ...
                JavaWebException.cast("更新支付记录状态失败");
            }
            ...
            if (update > 0) {
                ...
                JavaWebException.cast("更新订单表状态失败");
            }
        }
    ...
    public XcPayRecord createPayRecord(XcOrders orders){
        if(orders==null){
            JavaWebException.cast("订单不存在");
        }
        if(orders.getStatus().equals("600002")){
            JavaWebException.cast("订单已支付");
        }
