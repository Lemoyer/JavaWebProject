package com.javaweb.orders.api;
...
import com.javaweb.orders.util.SecurityUtil;
...
public class OrderController {
    ...
    public void requestpay(String payNo,HttpServletResponse httpResponse) throws IOException {
        ...
        if("601002".equals(status)){
            JavaWebException.cast("订单已支付，请勿重复支付。");
        }
        //构造sdk的客户端对象
...
//        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        alipayRequest.setNotifyUrl("http://4swzjt.natappfree.cc/orders/receivenotify");//在公共参数中设置回跳和通知地址
